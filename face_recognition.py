...
# Get model detect
## Case 1:
model = attempt_load("model_arch/weights/yolov5s-face.pt", map_location=device)
...
weight = torch.load("model_arch/backbones/resnet100_backbone.pth", map_location = device)
...
def read_features(root_fearure_path="static/facial_emb.npz"):
...
def recognition(face_image):
    ...
    scores = np.dot(query_emb, images_embs.T)[0]  
